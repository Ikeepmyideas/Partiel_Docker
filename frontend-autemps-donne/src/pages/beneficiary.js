...
function ParticipantsBenefList() {
    ...
    const handleDelete = (ID_Beneficiaire) => {
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activites/registrations/${eventId}/beneficiares/${ID_Beneficiaire}`, {
            method: 'DELETE'
        })
        .then(response => {
            if (response.ok) {
    ...
    const handleReminder = (ID_Beneficiaire) => {
        ...
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/notifications`, {
            method: 'POST',
            headers: {
            ...
            <section className="content">
                <div className="lists">
                    <div className="header">
                        <Link to={`/activity-details/${eventId}`}>
