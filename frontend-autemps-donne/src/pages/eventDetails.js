...
function EventDetails() {
    ...
    const fetchEventDetails = () => {
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activites/${eventId}`)
            .then(response => {
                if (!response.ok) {
    ...
    const fetchParticipants = () => {
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activites/registrations/${eventId}`)
            .then(response => {
                if (!response.ok) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activites/update/${eventId}`, {
            method: 'PUT',
            headers: {
