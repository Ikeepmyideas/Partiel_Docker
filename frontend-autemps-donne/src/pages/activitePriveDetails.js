...
function EventprvDetails() {
    ...
    const fetchEventDetails = () => {
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activitesprv/${eventId}`)
            .then(response => {
                if (!response.ok) {
    ...
    const fetchParticipants = () => {
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activitesprv/registrations/${eventId}`)
            .then(response => {
                if (!response.ok) {
    ...
    const fetchParticipantsBenef = () => {
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activites/registrationsBenef/${eventId}`)
            .then(response => {
                if (!response.ok) {
                    throw new Error('Failed to fetch participants');
                }
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetch(`https://au-temps-donne-api.onrender.com/api/admin/activitesprv/update/${eventId}`, {
            method: 'PUT',
            headers: {
                                       ...
                                       <div className="header">
                                        ...
                                        <div className="list-container">
                                            <div className="list-card">
                                                <h4>Bénévoles</h4>
                                                <Link id="voir" to={`/volunteers/${eventId}`} className="btn-link">Voir la liste</Link>
                                            ...
                                            <div className="list-card">
                                                <h4>Bénéficiaires</h4>
                                                <Link id="voir" to={`/beneficiaires/${eventId}`} className="btn-link">Voir la liste</Link>
                                                <div className="download-button">
